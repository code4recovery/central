export const strings = {
  ...
  activity: {
    approvedBy: "Approved by {user} on {date}",
    declinedBy: "Declined by {user} on {date}",
    empty: "No activity yet",
    approve: "Approve this change",
    change: "Change",
    changeApplied: "Change made",
  ...
  app_name: "Central",
  auth: {
    email_sent: `Now check your email. If you have an account, you will receive an email with a link to log in.`,
  ...
  email: {
    ...
    login: {
      ...
      headline: `Once you’ve confirmed that {email} is your email address, you’ll be logged in to the site.`,
      instructions: "Tap the button below to confirm:",
      subject: "Confirm your email address to log in",
    },
    request: {
      buttonText: "Approve request",
      headline: `{name} has requested to be added as a group representative for {group}.`,
  ...
  form: {
    ...
    invalidPhone: `Phone numbers should only contain digits or +,()-# characters`,
  ...
  help: {
    ...
    conference_providers_content: `Conference URLs should be links that the user can click to join the meeting directly. They should be links to widely-recognized services, and should go straight in to the meeting. Other types of URLs should go in the group website field.`,
    online_location: "Can online meetings have a location?",
    online_location_content: `Yes, online meetings can have approximate locations, such as Philadelphia, PA. These can be thought of as places of origin or affinity for the meeting. Specifying this will also set the meeting timezone.`,
    phone_format: "What's the recommended format for Zoom phone numbers?",
    phone_format_content: `Ideally the phone number should be in a format that can be dialed directly, such as +12125551212,,123456789#,,#,,444444# -- commas are used to add pauses, and double commas are used to add longer pauses. The commas are optional, but the # symbols are required.`,
  ...
  representatives: {
    ...
    warning_groups: `Editing this information will edit the user's profile. This user also represents: {groups}.`,
  },
  request: {
  ...
  users: {
    ...
    admin: "Admin",
    admin_description: `This user may add, edit, and remove other users, and adjust account settings.`,
    edit: "Edit User",
    edit_description: `Avatars are associated with email and can be updated at Gravatar.com`,
