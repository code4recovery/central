                ...
                <div className="bg-white px-4 py-5 sm:p-6">
                  <div className="grid grid-cols-6 gap-6">
                    ...
                    <fieldset className="col-span-6">
                      <legend className="sr-only">Supported Programs</legend>
                      <div
                    ...
                    <fieldset className="col-span-6">
                      ...
                      <div className="mt-4 grid grid-cols-3 gap-3 items-top">
                        {Object.keys(config.colors).map((color) => (
                          <div className="flex items-center" key={color}>
                            <input
                              ...
                              defaultChecked={config.color === color}
                            />
                            <label
                              htmlFor={color}
                              className={cx(
                                "ml-3 block text-sm font-medium leading-6 px-3 rounded text-white",
                                config.colors[
